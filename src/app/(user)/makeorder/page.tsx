...
//import { useRouter } from "next/router";  //only for page route
...
//console.log("ORDER IS SAVED TO DATABASE")
       ...
       // show order detail
        router.push('/submitedorderdetail')
  ...
  return (
    <Container className="my-[7%]">
      <div className="flex flex-col ">
        <h1 className="h3 ">Your order detail</h1>
